...
namespace ILAB_Illuminate\Filesystem;

use Carbon\Carbon;
use RuntimeException;
use ILAB_Illuminate\Http\File;
use ILAB_Illuminate\Support\Str;
use InvalidArgumentException;
use ILAB_Illuminate\Http\UploadedFile;
use ILAB_Illuminate\Support\Collection;
...
use ILAB_Illuminate\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use ILAB_Illuminate\Contracts\Filesystem\Filesystem as FilesystemContract;
use ILAB_Illuminate\Contracts\Filesystem\FileNotFoundException as ContractFileNotFoundException;
...
class FilesystemAdapter implements FilesystemContract, CloudFilesystemContract
{
     ...
     * @return string
     *
     * @throws \ILAB_Illuminate\Contracts\Filesystem\FileNotFoundException
     */
     ...
     *
     * @param  string  $path
     * @param  \ILAB_Illuminate\Http\File|\ILAB_Illuminate\Http\UploadedFile  $file
     * @param  array  $options
     * @return string|false
     */
